...
from lucas_kanade import lucas_kanade_optical_flow, my_lucas_kanade_step, my_warp_image
...
(du, dv) = my_lucas_kanade_step(I1, I2, WINDOW_SIZE_RIVER)
end_time = time.time()
statistics['[RIVER, TIME] One Step LK'] = end_time - start_time

# Warp I2
I2_one_lk_step = my_warp_image(I2, du, dv)
...
one_step_warped_image = my_warp_image(I2, du, dv)
plt.subplot(2, 2, 1)
plt.title('du')
...
I2_full_lk = my_warp_image(I2, u, v)
